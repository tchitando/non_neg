...
**SimCLR** gives 1.00% — equivalent to random, as expected. Features are dense with no class structure per dimension.

**NCL** gives ~10% on both our checkpoint and the paper's official checkpoint. 
